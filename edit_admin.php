...
<head>
    ...
    <title>Edit Admin - AuLaundry</title>
...
<body>
    ...
    <div class="main-content">
        <div class="mb-4">
            ...
            <p class="text-muted">Perbarui biodata pengelola sistem atau reset password.</p>
        </div>
                ...
                <div class="card card-custom p-4 bg-white">
                    <form action="proses_edit_admin.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="password" class="form-control" placeholder="Kosongkan jika password tidak ingin diganti">
