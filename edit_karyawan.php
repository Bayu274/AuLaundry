...
<head>
    ...
    <title>Edit Karyawan - AuLaundry</title>
...
<body>
    ...
    <div class="main-content">
        <div class="mb-4">
            <h2 class="fw-bold text-dark">Edit Data Karyawan</h2>
            <p class="text-muted">Perbarui informasi staf operasional outlet laundry.</p>
        </div>
            ...
            <div class="col-md-6">
                <div class="card card-custom p-4 bg-white">
                    <form action="proses_edit_karyawan.php" method="POST">
                        ...
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Posisi / Bagian</label>
                            <select name="posisi" class="form-select" required>
                                <option value="Kasir Depan" <?php echo ($data['posisi'] == 'Kasir Depan') ? 'selected' : ''; ?>>Kasir Depan</option>
                                <option value="Bagian Cuci" <?php echo ($data['posisi'] == 'Bagian Cuci') ? 'selected' : ''; ?>>Spesialis Cuci (Washing)</option>
                                <option value="Bagian Setrika" <?php echo ($data['posisi'] == 'Bagian Setrika') ? 'selected' : ''; ?>>Spesialis Setrika (Ironing)</option>
                                <option value="Pembersih Khusus" <?php echo ($data['posisi'] == 'Pembersih Khusus') ? 'selected' : ''; ?>>Pembersih Sepatu / Karpet</option>
                            </select>
                        </div>
