...
<head>
    ...
    <title>Tambah Kurir - AuLaundry</title>
...
<body>
    ...
    <div class="main-content">
        <div class="mb-4">
            <h2 class="fw-bold text-dark">Tambah Kurir Baru</h2>
            <p class="text-muted">Dafrarkan armada kurir baru ke dalam sistem database.</p>
        </div>

        <div class="row">
            <div class="col-md-6">
                <div class="card card-custom p-4 bg-white">
                    <form action="proses_tambah_kurir.php" method="POST">
                        
                        <div class="mb-3">
                            <label class="form-label fw-semibold">Nama Lengkap Kurir</label>
                            <input type="text" name="nama_kurir" class="form-control" placeholder="Contoh: Ahmad Dhani" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-semibold">No. HP / WhatsApp</label>
                            <input type="number" name="no_hp" class="form-control" placeholder="Contoh: 0813XXXXXXXX" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label fw-semibold">Username Akun Kurir</label>
                            <input type="text" name="username" class="form-control" placeholder="Contoh: ahmad_delivery" required>
                        </div>
                        ...
                        <div class="mt-4">
                            <button type="submit" name="simpan" class="btn btn-primary px-4 py-2 rounded-3 fw-bold me-2">
                                <i class="fa-solid fa-floppy-disk me-1"></i> Simpan Kurir
                            </button>
